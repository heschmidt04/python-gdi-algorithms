...
## Examples
example_one = [4, 4, 5, 5, 4, 3, 3, 4, 5, 77, 77, 77, 78, 79, 80, 81, 88, 90, 95, 100, 100, 110, 115, 135, 145, 158,
               158, 190, 200, 200, 200, 200, 200, 150, 100, 60, 7, 8, 8, 8]  # halogen
# halogen

example_two = [4, 5, 8, 9, 11, 2, 3, 4, 5, 6, 5, 4, 5, 4, 100, 110, 115, 135, 145, 158, 158, 190, 200, 200, 200, 200,
               200, 200, 200, 200, 190, 100, 90, 87, 80, 30, 25, 26, 27, 28, 29, 30, 30, 30, 30, 30, 30,
               30]  # florecent
# flourescent

example_three = [4, 4, 5, 5, 4, 3, 3, 4, 4, 4, 5, 5, 4, 3, 3, 4, 5, 100, 150, 200, 200, 200, 201, 201, 200, 201, 200,
                 199, 200, 200, 199, 201, 150, 4, 4, 5, 5, 4, 3, 3, 4, 9, 4, 4, 5, 5, 4, 3, 3, 4, 5, ]  # incandecent
# incandescent

example_four = [4, 4, 5, 5, 4, 3, 3, 4, 4, 4, 5, 5, 4, 3, 3, 4, 5, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200,
                200, 200, 200, 4, 4, 5, 5, 4, 3, 3, 4, 9, 4, 4, 5, 5, 4, 3, 3, 4, 5, ]  # LED
